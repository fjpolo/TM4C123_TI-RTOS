 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/TI_RTOS/Workspace/DSP_MAF_CB/Debug/configPkg/package/cfg/empty_min_pem4f");
...
#endif
#endif
const ti_sysbios_hal_Hwi_Handle Timer0 = (ti_sysbios_hal_Hwi_Handle)((ti_sysbios_hal_Hwi_Handle)&ti_sysbios_hal_Hwi_Object__table__V[0]);
