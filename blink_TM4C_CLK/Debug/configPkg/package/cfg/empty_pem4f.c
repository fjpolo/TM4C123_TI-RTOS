...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[7747];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/TI_RTOS/Workspace/blink_TM4C_CLK/Debug/configPkg/package/cfg/empty_pem4f");
...
__FAR__ const CT__ti_sysbios_hal_Hwi_E_stackOverflow ti_sysbios_hal_Hwi_E_stackOverflow__C = (((xdc_runtime_Error_Id)4100) << 16 | 0);
...
__FAR__ const CT__ti_sysbios_heaps_HeapMem_E_memory ti_sysbios_heaps_HeapMem_E_memory__C = (((xdc_runtime_Error_Id)4064) << 16 | 0);
...
__FAR__ const CT__ti_uia_loggers_LoggerStopMode_Module__id ti_uia_loggers_LoggerStopMode_Module__id__C = (xdc_Bits16)0x8032;
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1e43;
